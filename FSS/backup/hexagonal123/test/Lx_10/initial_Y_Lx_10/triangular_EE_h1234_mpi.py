...
#case1= X,case2= Z, case3= Y, case4= ground state of TC
case=3
...
for (tmp_i, ip, ids) in my_tasks:
    ...
    for it in range(NT):
        ...
        if it==NT-1:
            ...
            #ナフタレン型
            A2 = subset6(L,Ax,Ay,Lx,Ly,p_indd)|subset6(L,Ax-1,Ay+1,Lx,Ly,p_indd)
            B2 = subset6(L,Bx,By,Lx,Ly,p_indd)|subset6(L,Bx-1,By-2,Lx,Ly,p_indd) - A2
            C2 = subset6(L,Cx,Cy,Lx,Ly,p_indd)|subset6(L,Cx+2,Cy+1,Lx,Ly,p_indd) - A2 -B2
            ...
            #アントラセン型
            A3 = subset6(L,Ax,Ay,Lx,Ly,p_indd)|subset6(L,Ax-1,Ay+1,Lx,Ly,p_indd)|subset6(L,Ax-3,Ay,Lx,Ly,p_indd)
            B3 = subset6(L,Bx,By,Lx,Ly,p_indd)|subset6(L,Bx-1,By-2,Lx,Ly,p_indd)|subset6(L,Bx,By-3,Lx,Ly,p_indd) - A3
            C3 = subset6(L,Cx,Cy,Lx,Ly,p_indd)|subset6(L,Cx+2,Cy+1,Lx,Ly,p_indd)|subset6(L,Cx+3,Cy+1,Lx,Ly,p_indd) - A3 -B3
            ...
            #アントラセン+ベンゼン型
            A4 = subset6(L,Ax,Ay,Lx,Ly,p_indd)|subset6(L,Ax-1,Ay+1,Lx,Ly,p_indd)|subset6(L,Ax-3,Ay,Lx,Ly,p_indd)|subset6(L,Ax-4,Ay-2,Lx,Ly,p_indd)
            B4 = subset6(L,Bx,By,Lx,Ly,p_indd)|subset6(L,Bx-1,By-2,Lx,Ly,p_indd)|subset6(L,Bx,By-3,Lx,Ly,p_indd)|subset6(L,Bx+2,By-2,Lx,Ly,p_indd)  - A4
            C4 = subset6(L,Cx,Cy,Lx,Ly,p_indd)|subset6(L,Cx+2,Cy+1,Lx,Ly,p_indd)|subset6(L,Cx+3,Cy+3,Lx,Ly,p_indd)|subset6(L,Cx+2,Cy+4,Lx,Ly,p_indd) - A4 -B4
            ...
            print(f"rank={rank:>3} Lx=Ly={Lx:>2} pg={pg:>6.3f} ids={ids:>4} TEE1={TEE1:>2} TEE2={TEE2:>2} TEE3={TEE3:>2}  TEE4={TEE4:>2}", flush=True)
...
if rank == 0:
    ...
    # npzファイル保存
    for Lx in data_set:
        np.savez_compressed(f"Lx_{Lx}_Nd_{Nd}_NT_{NT}_px_{px}_MPI_hexagonal123.npz", 
                            pg=data_set[Lx]["pg"],
