            ...
            if it==NT-1:
                ...
                for Ax in range(Lx):
                    for Ay in range(Ly):
                        ...
                        print("TEE2",len(A2),len(B2),len(C2))
                        print("A2=",A2)
                        print("B2=",B2)
                        print("C2=",C2)
                        ...
                        print("TEE3",len(A3),len(B3),len(C3))
                        print("A3=",A3)
                        print("B3=",B3)
                        print("C3=",C3)
                        ...
                        print("TEE4",len(A4),len(B4),len(C4))
                        print("A4=",A4)
                        print("B4=",B4)
                        print("C4=",C4)                
...
if rank == 0:
    ...
    for Lx in data_set:
        ...
        np.savez_compressed(f"Lx_{Lx}_Nd_{Nd}_NT_{NT}_pz_{pz}_MPI_hexagonal5.npz", 
                            pg=data_set[Lx]["pg"],
