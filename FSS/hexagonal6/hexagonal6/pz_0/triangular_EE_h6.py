...
if rank == 0:
    ...
    for Lx in data_set:
        ...
        np.savez_compressed(f"Lx_{Lx}_Nd_{Nd}_NT_{NT}_pz_{pz}_MPI_hexagonal6.npz", 
                            pg=data_set[Lx]["pg"],
        ...
        print("pz=",pz,"Np=",Np,"Nd=",Nd,"NT=",NT,"time=",int(time_end-time_start))
