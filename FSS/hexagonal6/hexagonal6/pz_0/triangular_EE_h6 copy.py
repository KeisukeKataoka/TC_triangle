            ...
            if it==NT-1:
                ...
                for Ax in range(Lx):
                    for Ay in range(Ly):
                        ...
                        # h2
                        A2 = (A1 | subset6(L, (Ax - 1) % Lx, (Ay + 1) % Ly, Lx, Ly, p_indd))
                        B2 = (B1 | subset6(L, (Bx - 1) % Lx, (By - 2) % Ly, Lx, Ly, p_indd)) - A2
                        C2 = (C1 | subset6(L, (Cx + 2) % Lx, (Cy + 1) % Ly, Lx, Ly, p_indd)) - A2 - B2
                        ...
                        # h3
                        A3 = (A2 | subset6(L, (Ax - 3) % Lx, Ay, Lx, Ly, p_indd))
                        B3 = (B2 | subset6(L, Bx % Lx , (By - 3) % Ly, Lx, Ly, p_indd)) - A3
                        C3 = (C2 | subset6(L, (Cx + 3) % Lx, (Cy + 3) % Ly, Lx, Ly, p_indd)) - A3 - B3
                        ...
                        # h4
                        A4 = (A3 | subset6(L, (Ax - 4) % Lx, (Ay - 2) % Ly, Lx, Ly, p_indd))
                        B4 = (B3 | subset6(L, (Bx + 2) % Lx, (By - 2) % Ly, Lx, Ly, p_indd)) - A4
                        C4 = (C3 | subset6(L, (Cx + 2) % Lx, (Cy + 4) % Ly, Lx, Ly, p_indd)) - A4 - B4
                        ...
                        # h5
                        A5 = (A4 | subset6(L, (Ax - 5) % Lx, (Ay - 4) % Ly, Lx, Ly, p_indd))
                        B5 = (B4 | subset6(L, (Bx + 4) % Lx, (By - 1) % Ly, Lx, Ly, p_indd)) - A5
                        C5 = (C4 | subset6(L, (Cx + 1) % Lx, (Cy + 5) % Ly, Lx, Ly, p_indd)) - A5 - B5
                        ...
                        # h6
                        A6 = (A5 | subset6(L, (Ax - 4) % Lx, (Ay - 5) % Ly, Lx, Ly, p_indd))
                        B6 = (B5 | subset6(L, (Bx + 5) % Lx, (By + 1) % Ly, Lx, Ly, p_indd)) - A6
                        C6 = (C5 | subset6(L, (Cx - 1) % Lx, (Cy + 4) % Ly, Lx, Ly, p_indd)) - A6 - B6
